...
class AppTranslations extends Translations {
  ...
  'assistant': "I'm your assistant, ask me",
  'ask_me': 'Ask me anything about the app...',
  'choose_your_avatar': 'Choose your avatar',
  'pick_from_gallery': 'Pick from gallery',
  'select': 'Select',
  'avatar_updated': 'Avatar updated successfully',
  'image_updated': 'Image updated successfully',
  'success': 'Success',
  'im_here_to_help': 'I’m here to help! If you have a technical issue, check our FAQ or contact support. You can also access detailed tutorials for using your bracelet, adding payment methods, or locating a lost bracelet. Our 24/7 support team is available via email or the in-app chat.',
  'technical_issue': 'If you’re facing a bug or connection issue with your bracelet or payment, please consult our FAQ for quick fixes or reach out to our technical support team.',
  'tutorials': 'You can find detailed tutorials in the app to activate your bracelet, add a payment method, or use the geolocation feature to find a lost bracelet.',
  'contact_details': 'You can reach us at: Email: [support@example.com], Phone: [+1 234 567 8900], or use the in-app chat (Monday to Friday, 9 AM - 6 PM). Our postal address is SmartBracelet Technologies, 12, Rue de l’Innovation, 75008 Paris, France. Expect a response within 24-48 hours.',
  'privacy_info': 'Your data security is our priority. We collect personal info (name, email), GPS data, and payment history, used only for transactions, bracelet tracking, and service improvement. Data is encrypted, and we don’t sell it. You can request data deletion via account settings.',
  'data_deletion': 'You can request data deletion anytime through your account settings.',
  'sorry_cant_help': 'Sorry, I can’t help you with that. I’m only specialized in this app. Please ask about help & support, contact details, or privacy policy!',
        },
        'fr_FR': {
          'assistant': "Je suis votre assistant, posez-moi une question",
  'ask_me': 'Posez-moi une question sur l’application...',
  ...
  'success': 'Succès',
  'im_here_to_help': 'Je suis là pour vous aider ! Si vous avez un problème technique, consultez notre FAQ ou contactez le support. Vous pouvez aussi accéder à des tutoriels détaillés pour activer votre bracelet, ajouter un moyen de paiement ou localiser un bracelet perdu. Notre équipe de support est disponible 24h/24 via email ou le chat intégré.',
  'technical_issue': 'Si vous rencontrez un bug ou un problème de connexion avec votre bracelet ou un paiement, consultez notre FAQ pour des solutions rapides ou contactez notre support technique.',
  'tutorials': 'Vous pouvez trouver des tutoriels détaillés dans l’application pour activer votre bracelet, ajouter un moyen de paiement ou utiliser la géolocalisation pour retrouver un bracelet perdu.',
  'contact_details': 'Vous pouvez nous joindre à : Email : [support@example.com], Téléphone : [+1 234 567 8900], ou via le chat intégré (lundi au vendredi, 9h-18h). Notre adresse postale est SmartBracelet Technologies, 12, Rue de l’Innovation, 75008 Paris, France. Réponse sous 24-48h.',
  'privacy_info': 'La sécurité de vos données est notre priorité. Nous collectons des informations personnelles (nom, email), des données GPS et l’historique des paiements, utilisées uniquement pour les transactions, le suivi du bracelet et l’amélioration des services. Les données sont chiffrées et non vendues. Vous pouvez demander leur suppression via les paramètres.',
  'data_deletion': 'Vous pouvez demander la suppression de vos données à tout moment via les paramètres de votre compte.',
  'sorry_cant_help': 'Désolé, je ne peux pas vous aider avec cela. Je suis spécialisé uniquement dans cette application. Veuillez poser des questions sur l’aide, les contacts ou la politique de confidentialité !',
